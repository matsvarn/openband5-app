...
| Storage | Schema **62**, additive migration and same-version repair. Durable sleep drafts, correction revisions and calculation jobs (52); workout templates, meal drafts and frozen session-detail snapshots (53); user lap marks (54); durable nap recalculation jobs and original bounds (55); optional sleep-goal periods (56); per-result lab report bounds (57); template pin/archive (58); durable live strength state (59); custom-field visibility (60); dated nutrition targets (61); exercise registry provenance (62). Original records remain retained. |
...
## Active continuation · 20 September 2026, exercise registry active

Lead owns scope, Paper, integration and acceptance. Edge only, branch `openband5/ios-device-setup`. No push/deploy/personal-data/physical-device/Bluetooth authority. Preserve six unrelated untracked assets. Mats task `/private/tmp/openband-alpin-20260919`; clones have no origin. Minimal copy and near-exact Paper/native parity required.

Accepted: `2080b03` saved-food editing, `01d6786` retained-draft/water atomic contracts, `87b0fc3` overview queue, `a1078f9` sleep queue, `f0d60b4` nutrition parent/week/recent/water flows (949tests;38Pro+38mini PNGs all inspected). Earlier version69aca3d, Journal080d971 and dated-goalsada1ff8. Latest accepted unit is `1550b9b`, coming-night sleep planning. Evidence in IMPLEMENTATION_VERIFICATION.md.

Latest unit: typed current-day forecast with exact input-read provenance, saved-edit/served-row freshness, no wrong-night attainment, coming wake-day goal route.1002required tests,45producer tests,60-item analyzer and integration analyzer clean; manifest118blocks285screens.12goldens and46final native PNGs all inspected. Pro sleep-plan-pro-final-20260920 PASS62.92s; mini sleep-plan-mini-final-20260920 PASS78.55s,23states each, receipts reconciled. New Paper summary45AL/schedule45AS and20variants, parent3G8S top/header corrected, shared settings row reused. Paper exact exports at task/sleep-plan-paper; -v2 supersedes originals.

Exercise picker unit verified and ready for local commit:1045required tests;63-item analysis clean; manifest120blocks315screens;20goldens and52 final native PNGs all inspected. Pro exercise-picker-pro-accepted-20260920 PASS93.13s; mini exercise-picker-mini-accepted-20260920 PASS116.30s,26states each. Final capture66a8fb65/fc2de64c proves the whole last Add control and sheet round trip at2x; IME refill/save/reopen passes. Independent data/UI findings corrected. Details in IMPLEMENTATION_VERIFICATION.md. No more checks warranted without a new change.

Active next-unit worker: custom-exercise-contract06656813/e9565e81, Grok Cursor, isolated task/custom-exercise-contract-clone,900s deadline. Owns typed B26 definitions, original load semantics, persistence and focused tests only. Baseline includes this picker unit before commit; integrate only worker-owned diffs. Lead owns Paper/UI/integration; no production UI writer yet. Preserve historic normalized load_kg and unknown basis; never multiply history. API/UI handoff pending result.

Next outcome: custom exercise creation and end-to-end original load semantics. B26/B36/B83 and frozen Phase2 M8H are the source contract. Name and consciously selected equipment/mode are required; muscle groups optional. Saving adds a definition to the same library context unselected. Plus selects it; confirm adds to the template draft; saving the template is separate. New typed original load/basis/count/repetition metadata must reach recorded sets and exports without reinterpreting historic load_kg. Copy/rename retains correct identity and snapshots. Registry selection and empty timed plans are accepted; ad hoc entry remains reachable until this migration replaces it.

Remaining: genuine sleep/health states; nutrition search/manual/barcode/photo/Health/recipes/favorites/customfoods and day close; Journal ordering/pins/timed entries; training catalogue/custom/archive/templates/history/non-run live flows; A08import/export/coach/widgets; glucose permission/error distinctions, cycle flags, medication history; overview lower feed/customization/live chip. SOL is stored; SpO2 producer disabled. Missing repository methods/tables are not deferral reasons. Old Home/Health/Wellness have no lib constructor callers; legacy MetricDetail/SleepDetail depend on that dead graph. Retire dead code after checking retained helpers/tests in a separate unit.
...
Release source0.9.31+67,algo90,schema62; protocolfe1464db98b84ac4d3ce6175d54ada11356d6c62 and analytics1fa8144a5e3b728ce91eeed6ecbc15d482933b44 match lock. SDK ~/.local/share/flutter/3.41.6/bin/flutter. Widget/watch versions reconciled; final readiness remains open. Never create test/goldens. Continue through queue; not all screens are done.

A08 source audit29205901/dfc6d24c: reachable ProfileHome → MoreSettings → DataScreen/AutomationSettings and CoachSetup already own real writers. Import completion, backup and CSV exist; selection/range/partial export and originals manifest remain open. Coach setup exists; enforced data grants/style/memory do not. Widget/watch writers exist; dated snapshots/setup/deep links need work. Native iOS source IS within edge and may be changed; only signed-device/provider/OS installation validation needs separate access. Do not inherit the audit's overly broad “out-of-edge” label for code. Full report in Mats worker state.

Next B26 Paper preview47SX/47WB and empty47YE use shared comfortable settings rows, explicit equipment/mode/weight basis/device count/repetition basis; optional muscle categories. Light/dark renders inspected; exports and further variants pending. Saving a definition returns to the same library context unselected; adding to a plan and saving it remain separate actions.

B26 Paper exports: task/custom-exercise-paper. Definition47SX/dark47WB, empty47YE/dark485H, error483C/dark487K, equipment480H/dark489P, weight basis48CK/dark48FE all rendered/inspected. Reuse OBSettingsValueRow comfortable and choice rows; no extra instructional paragraphs. Remaining variants and UI integration pending.
