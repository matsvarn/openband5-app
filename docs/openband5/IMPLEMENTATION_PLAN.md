...
| Storage | Schema **64**, additive migration and same-version repair. Durable sleep drafts, correction revisions and calculation jobs (52); workout templates, meal drafts and frozen session-detail snapshots (53); user lap marks (54); durable nap recalculation jobs and original bounds (55); optional sleep-goal periods (56); per-result lab report bounds (57); template pin/archive (58); durable live strength state (59); custom-field visibility (60); dated nutrition targets (61); exercise registry provenance (62); original strength load and definition snapshots (63); imported measurement source/timing, receipts and exclusions (64). Original records remain retained. |
...
Authority: edge/, branch openband5/ios-device-setup, PR1. No push/merge/deploy or personal-data/physical-device/Bluetooth authority. Preserve six unrelated untracked assets. Mats task `/private/tmp/openband-alpin-20260919`; isolated clones have no origin. Minimal visible copy and near-exact Paper/native parity are acceptance requirements. **Not all screens are complete; continue through the queue.**

Latest verified unit: **Glucose** (**5295d34**), following **c2b71a1** B26 custom exercise/original load.1241 required tests,72-item analysis,81 affected tests;122blocks375screens;22goldens and68 final native PNGs inspected. Full evidence in IMPLEMENTATION_VERIFICATION.md. Schema64, algorithm90, app0.9.31+67, full pins unchanged. Earlier accepted06523ff library selection,1550b9b sleep plan,f0d60b4 nutrition parent/week/water. Do not rebuild accepted work.

Glucose source/UI/Paper and13 checklist dispositions integrated. DATA71 fixes corrupt lookahead, explicit legacy keys, same-ts unit ordering, finite import timestamps and DateTime boundary. UI33 has readable large-value wrapping and local older-year dates. Source excluded history stays stored; import persistence differs from refreshed-read success. Chart uses actual timestamps and original unit, no interpolation or targets. PhoneImport now routes glucose into the canonical flow; the rest of that legacy page still needs its own redesign.

| Worker | Accepted result / ownership |
| --- | --- |
| 643dd244 glucose-data-final, GrokPi | 67164deb71tests/10-file analysis; e68b26df removes last unused count helper, db analysis clean. Integrated10ownedfiles. Idle. |
| eb6de974 glucose-ui-successor, GrokCursor | 7cc1e39633tests/scoped analysis; integrated UI and19 unchanged inspected goldens. Idle. |
| 2f5fe16a glucose-chart-final, SolPi | 794c778214tests/scoped analysis; bounded numerical repair accepted;3goldens inspected. Idle. |
| 9742215d custom-exercise-capture, GrokPi | 462d489c actual switch/scroll targets;34-frame glucose harness integrated. Lead Pro final128.23s/Mini142.53s PASS, every PNG inspected. Idle; no native process active. |
| 0f41d07b glucose-data-review, GrokCursor | 117689d3 independent correction review clear. Prior UI18ad6c01 clear. Read-only, idle. |
| e68e0ada a08-state-reconcile, GrokCursor | 4e134dc6 confirms A05 Eigener Marker and A08 Übertragung · unterbrochen aliases; next small documentation unit, lead acceptance still required.68350aa0 has12 copy-polish candidates, mostly disclosure text; preserve useful source/uncertainty information. Idle. |
| 39db72bf glucose-contract-audit, GrokCursor | Medication source/contract discovery bd68f739,6dcb8cd7,0e417d90 only. No implementation. See next unit below. Idle. |

Retired uncertain writers must not resume: glucose b6b98f0f (Cursor connection lost; PGID21634 absent, artifacts retained and reconciled); UI37d63b39; chart e12c263d/879513c5; journal7da2faf5. Exact reconciliation evidence lives in task state. Unauthorized remote origin/openband5/journal-custom-fields at987b9e920754eb66f7e34264c85f3497d2950562 was deleted with explicit exact-head authority and verified absent; no other remote writes.

The two proven aliases are reconciled in this documentation unit: A05 Eigener Marker reuses the lab editor; A08 interrupted transfer reuses the overview sync row. No UI rebuilt. Next: Paper/design/implementation for medication. Medication has real MedDb/coach writes but a dead Wellness/reminder destination; unknown doses mislabeled missed, slug identities can overwrite history, edits do not re-arm reminders, and midnight+minutes scheduling mishandles DST. Next schema is65. Do not backdate current schedules to created_at, do not fill legacy dose metadata from current definitions, and keep real logs when a plan ends. Reuse day_label/time.dart and notification emitter; resolve same-day revision/end semantics and DST recurrence before delegating. Audit proposals are not accepted architecture. Archived actual medication references (read-only Phase2, S-0):3B1U main,3B8C add,3BA8 record,39UY manage,39WU history; all inspected. No new Phase3 medication design or worker yet.

### Remaining queue

Training definition management/archive/templates/history/non-run live; nutrition search/manual/barcode/photo/Health/recipes/favorites/customfoods/day close; journal ordering/pins/timed; A08 import/export/coach/widgets; cycle flags/history, medication history; overview lower feed/customization/live chip. Reconcile unmarked archive names against source/Paper/tests; a missing repository method is not grounds for deferral. Labs and their custom-marker alias are implemented and reconciled. Retire dead Home/Health/Wellness graph only after retained helpers/tests are checked.

A08 audits29205901/dfc6d24c and58488304/e58ec49e: real CSV/database writers exist. Range DB omits raw_archive/raw_records and cannot be called an originals archive. Preserve unknown timestamps/undecodable records. Share-sheet completion is not saved-file proof. Native iOS code is inside authorized edge; provider/device proof needs separate authority. Cycle has two enable flags and inconsistent >60d prediction refusal; medication stores/reminders exist, old Wellness destination is dead and medication reminder routes Journal.

Release source0.9.31+67,algo90,schema64. Protocolfe1464db98b84ac4d3ce6175d54ada11356d6c62 and analytics1fa8144a5e3b728ce91eeed6ecbc15d482933b44 match lock. Widget/watch six configs reconciled69aca3d. Final release-readiness audit remains open. Flutter ~/.local/share/flutter/3.41.6/bin/flutter.

Glucose contract audit39db72bf/a07b13fb complete: pinned health12.2.1 emits mg/dL, iOS sourceId bundleID/Android sourceName package; read authorization opaque on iOS. Store unit remains authority, no mmol hard-code/conversion. Namespace legacy name-only identity separately. Backend assigned additive schema64 nullable import/source fields plus durable receipt/exclusion, glucose-only manual import via shared importer, legacy four-kind caller migration, empty/error distinction, finite/unit validation, unchanged reread retains import stamp. No new Android history permission or automatic sync.

A08 audit e68e0ada/a0a4513c and correction6bdb0d2c accepted as discovery only. Legacy Profile/Settings/Data/Coach/Devices behavior remains partial until Alpin Paper/native. Only proven unmarked alias is interrupted transfer -> A01; receiving/completed still need exact evidence. Storage-full and incomplete-removal remain open, not unsupported merely because enum/UI absent. Reports in task worker directory. Interrupted-transfer alias is now closed using the additional 4e134dc6 source/native reconciliation.

Supporting discovery21:22UTC: medication audit39db72bf/bd68f739 confirms real MedDb/coach writes but dead Wellness and /meds reminder destination. Unknown dose response is currently mislabeled missed; duplicate slug creation can overwrite/rebind retained logs; reminders not rearmed on plan/dose changes; medSlotInstant adds seconds from midnight (DST wall-time bug). Archived actual Alpin med refs on S-0:3B1U main,3B8C add,39UY manage,39WU history; lead visually inspected these. Need stable identity, preserved historical metadata, explicit unknown/taken/skipped, route/reminder correction before completion. Full report in task. No medication implementation assigned.

Sleep/health reconciliation e68e0ada/1073e6c1: A05 Eigener Marker is the implemented Labor alias (3LXY/3LZI, labs-v3 native), verified and closed in this documentation unit. Sleep hub and health hub/HRV full Paper/native parity remain open despite individual completed detail units. A02 dispositions include partial states; do not equate disposition coverage with completion.


Medication follow-up39db72bf/6dcb8cd7 proposes revisions/dose snapshots and existing water-shaped route; discovery only. Lead rejects stale schema64 (Glucose owns64), retaining broken midnight+minutes DST helper, and treating a migration copy of current schedule as proof of original pre-edit history. Future design must preserve known revisions and uncertainty, use wall-time DST-safe instants, and keep current labels distinct from frozen historical metadata. No medication implementation yet.
