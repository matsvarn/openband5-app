...
**The redesign is incomplete. Continue through the queue, committing each accepted unit locally.** Work only in `edge/`, branch `openband5/ios-device-setup`, PR1. No push, merge, deploy, personal data, physical device or Bluetooth authority. Preserve six unrelated untracked assets. Mats task: `/private/tmp/openband-alpin-20260919`; workers use origin-free isolated clones. Lead owns Paper, source review, integration and acceptance. Keep visible copy short and Paper/native closely matched.

Latest accepted commit **c62ee9e**, optional recorded-gap history. Prior recorded observation counts:4b5b92c. The preceding measured cycle night history is c9c7a7b. Required1562 tests and85-item analysis passed; DATA44 under America/Los_Angeles, UI25, raw cycle54 and health6 passed. All26 changed goldens inspected. Pro42 native frames PASS87.09s, mini42 PASS130.8s; all84 PNGs and run metadata inspected. Production hashes match native runs. Paper35 exports are in task `cycle-measurements-paper/`;16 corrected info footers also inspected. See IMPLEMENTATION_VERIFICATION.md for exact evidence and worker reviews. No physical or physiological proof.

Earlier accepted units: raw cycle9f78b21, medication plans18f4379, glucose5295d34, aliasesffe4706, custom exercise/loadc2b71a1, library06523ff, sleep plan1550b9b, nutrition parent/week/waterf0d60b4. Do not rebuild them. The raw cycle unit had1493 required tests,82-item analysis and73 native frames each on Pro/mini. Its analytical scope remains partly open.

### Accepted unit: recorded observation counts

Recorded observation counts are complete in this commit. Required1591 tests,86-item analysis and final harness analysis pass; all24 changed goldens inspected. Pro29frames PASS71.95s and mini29frames PASS99.13s, all58 final PNGs/run metadata inspected. Source contracts, Paper24 variants and16 root-nav updates accepted. Worker745f8555 DATA12 tests; cd945f6e UI17/root54 plus capture repair4cd17e46; fresh813ba56c/b8e890df no remaining findings. Full evidence in IMPLEMENTATION_VERIFICATION.md. No workers remain active for this unit.

### Accepted unit: optional observed-gap history

Optional `Zyklus → Abstände` is complete in this commit. Closed contributing starts only, civil dates, no current open interval; fewer than12 gaps, any gap over60 days, duplicate or unreadable starts withhold the chart. Tracking off and display off remain distinct. The saved display toggle preserves other settings and distinguishes saved-but-refresh-failed from write failure. Groups contain up to12 real intervals, newest first; one-bar groups stay narrow and centered. Existing sourced chart extends to bars without changing line behavior.

DATA worker028914dc/43e86447 and UI24b4cd30/f48cc4f3 are accepted and idle. UI followup13a46fd3 added dark2x disclosure/chooser capture. Fresh reviewer45c7ce11/113c4ef0 and dbb1caa0 found no remaining production defects; the drag-test finding was corrected. Lead inspected actual source/diff, all30 new and23 regenerated root golden PNGs (43 changed/new), all64 native PNGs and run metadata. Required1620 tests and88-item analysis pass; focused DATA14, UI15, root54, final harness analysis pass. Pro32 checkpoints PASS71.92s; mini32 PASS108.74s. Logs and review sheets remain under the Mats task; full evidence is in IMPLEMENTATION_VERIFICATION.md.

Paper38 real screen exports and3 canonical block exports were refreshed in task `cycle-gaps-paper/` after final parity fixes. All affected renders inspected: correct Lucide ruler, intrinsic baseline-aligned value/unit, large-text date wrapping, chooser safe-area padding and overlays, disabled saved-refresh toggles. Sixteen root nav variants updated; four full scroll canvases expanded to fit. Canonical bars4MOQ/light and4MQG/dark remain on Bausteine. Registry125blocks/559screens. No source/schema/algorithm/dependency/version change beyond the UI contract. No remote writes or physical proof.

### Accepted prerequisite: cheaper cycle-night reads

Worker6233f821 followupccd1cdb6 is accepted and idle. `readCycleMeasurements` now uses Dart JSON decoding in an isolate and returns only imported, sleep_source, sleep and clinical. It avoids unused SeriesCodec expansion while preserving duplicate-key last-wins, JSON types, metadata, exact algorithm and correction receipt behavior. SQL still loads at most120 raw payload strings; this does not claim a SQL projection or solve the forthcoming year reader's memory bounds. No UI or Paper change; measured variants4HBH/4HG7 remain canonical.

Fresh reviewer7db41698/bca0da10 found no correctness break against c62ee9e. Lead compared the immutable review snapshot with final source: only a comment changed in production; benchmark prints/import were removed from the test. Final actual diff and evidence inspected. Focused contract/store48 tests passed under America/Los_Angeles; required1624 tests and88-item analysis passed. Projection probe is one local observation, not a performance guarantee. See IMPLEMENTATION_VERIFICATION.md. No remaining reader assignment.

### Next cycle outcomes

Pure DATA worker **22aa37e7-b6da-4dca-9b3b-2bd71ffdfc0b**, assignment **ed57dab7-f848-4330-a2ba-40124d758e0a**, running1500s in origin-free `cycle-medians-data-clone` basec62ee9e. Scope only new cycle_medians_data.dart and contract tests. Lead locked actual twelve-month windows using fixed anchor+1 half-open calendar boundaries, whole-year page offsets and no leap drift. Tracking/invalid starts withhold; estimates/display settings do not gate. Exclude only intersecting closed gaps>60 or open ages>60 and label remaining subset partial. Median>=2 distinct recorded periods per point, >=3 eligible cycle days per chart; dense holes through last qualifying day. Pinned analytics median and raw-night robustBaseline/mdc proxy, no sensor-error or significance claim. Preserve independent RHR/HRV source contributors and confidence/bounds/algo. No latest-vs21 z comparison yet. Brief and steering in Mats task. Repository/UI assignment waits on accepted prerequisites and complete Paper states.

Paper draft for the next median unit: main4MX3/dark4N1K, canonical median4N0F/dark4N4Z; window picker4MWU/dark4N4Q. Component roots4MWT/4N4P and4N0E/4N4Y are on Bausteine, normal/dark screens on S-0. All6 representative renders inspected; these are **drafts, not implemented or registered yet**. They reuse the measured cards with `Median · Tag23` / selected3-cycle count, preserve gaps and put actual12-month window in a44-target pager. Page top/footer intact. Fixture proposal reuses existing kCyclePaperRhr/Hrv arrays at starts2026-06-29,07-31,08-24; three recorded cycles, same per-day synthetic values, no fabricated real readings. Info/source and missing/partial/error/large variants still need design. Generalize sourced chart points to numeric-day-capable values/captions rather than faking MetricPoint dates; keep one painter and migrate sourced callers.

Supporting source discovery e68e0ada/bb624e37 completed and read. Exact-algo date-bounded SQL already exists in readCycleMeasurements; recentDayResults120 uses max<=90 and must not migrate. All start periods are available, but selected read truncates to120civil nights. Cross-cycle range must be separate. Lead chose an explicitly dated twelve-calendar-month window with earlier-window access, following B55; no365-as-year shortcut. Comparison references the actual latest metric night inside the selected window, independently per metric. Cross-cycle DATA is assigned above; UI waits on the accepted contract and complete Paper states.

Discovery **e68e0ada / eeee6340** and earlier343bee3a/ff87cc30 reports remain in task. Optional observed-gap history uses existing opt-in `lengthReviewEnabled`, at least12 gaps, any gap>60 withholds; no unsourced24/38 clinical guides. Cross-cycle medians/comparisons need a cross-cycle query reusing accepted night parsing. The twelve-calendar-month window and exclusion rules are locked above; Paper state coverage is still in progress. The selected-cycle120-night cap is not that query.

Source follow-up e68e0ada/27b34baa identified full-bundle series expansion; the reader prerequisite above addresses the selected-cycle path. The wider query must retain Dart duplicate-key semantics and correction receipts while bounding raw payload batches. Do not substitute scalar rhr/rmssd columns. Discovery e68e0ada/7ccc56d7 established B55's twelve-calendar-month windows; the old120-row cap was not a design promise. Long intersecting periods are excluded from medians without discarding other valid periods, with visible partial status.

Use pinned analytics `median`, `robustBaseline(minValid:3)`, `mdc`, `z`, not formulas in edge. Same-cycle-day median needs at least2 cycles per point and3 eligible points; dense holes/per-point counts. Noise uses eligible nights, zero MAD abstains. Compare actual latest metric night against preceding21 civil days and same day in at least3 prior cycles. No skin-temp-z relabelling, calendar phase or fertility claims. Exact algo90 clinical RHR/sessionRMSSD, actual sleep bounds, correction receipt/source gates; never scalar HRV fallback, max-version rows or oldest-n metricSeries.

Lead also verified the resolved pinned package source: `ana.z(x, sample)` uses ordinary mean/sample SD and abstains on undefined/zero SD; robustBaseline/mdc are a separate MAD-based noise proxy, not measured sensor error or coverage. Legacy getCycle actually reads recentDayResults(120), not metricSeries for its overlay; it lacks exact-algorithm/as-of/provenance gates. Avoid carrying its calendar phase or fabricated starts-count confidence into new contracts.

Retire legacy `CycleTab`, analytical `_CycleHistory`, `getCycle` only after all supported outcomes/callers/tests migrate. Preserve OpenBand raw `_CycleHistory`. `rough_night.dart` currently infers luteal phase from calendar; reachable legacy SleepDetail/MetricDetail/Home/Wellness paths need migration/removal. Tests to retarget include ui2_cycle_history, ui2_home_health_golden, local_repository_p0, ui2_revision_reload and ui2_tokens.

### Remaining queue and source findings

- Training discovery **c2978810 / db1b579a** and alias refresh **f56f12cd** are read. List edit/duplicate/pin/archive already work. Main commits **ad82c97** actions and **daa5c0e** editor preservation are verified; do not cite worker-clone SHAs as accepted main commits. A06b “Vorlage · neu” aliases empty editor478P; “Vorlage · gespeichert” returns to saved list without a receipt/toast. Save failure has draft retention/retry/native evidence but lacks an explicit template Paper state; visual requirement remains open. Do not use strength-live3OV4. No alias checklist edits yet.
- Open training: definition copyB65 (new UUID, metadata only, copiedFrom, no history/loads); definition management/archiveB69 (CAS exists, no archive UI/storage); template reorder/replace/superset/load-following; training historyB20/B81; non-run starts still reach legacy WorkoutScreen.
- Nutrition search/manual/barcode/photo/Health/recipes/favorites/custom foods/day close; journal ordering/pins/timed; A08 import/export/coach/widgets; overview lower feed/customization/live chip; full sleep/health/HRV parity. Labs/custom-marker and interrupted-transfer alias already reconciled. Dispositions are not blanket completion.
- A08 source audits **29205901/dfc6d24c** and **58488304/e58ec49e**: real CSV/database writers exist. Range DB export omits raw_archive/raw_records and cannot claim originals. Preserve unknown timestamps/undecodable records. Share-sheet completion is not saved-file proof. Storage-full, originals export, incomplete removal, coach and widgets remain supported work. Copy auditbcea9869: trim instructions, retain source/uncertainty/save-versus-refresh facts.
- Release: app **0.9.31+67**, schema65, algorithm90; protocolfe1464db98b84ac4d3ce6175d54ada11356d6c62 and analytics1fa8144a5e3b728ce91eeed6ecbc15d482933b44 match lock. Six shipping widget/watch configs0.9.31/67; three RunnerTests configs0.9.29/65 need final reconciliation. Flutter `~/.local/share/flutter/3.41.6/bin/flutter`. Final release audit remains open.

The unauthorized journal-custom-fields remote branch was deleted earlier with explicit exact-head authority and read-back. No other remote writes. Detailed accepted evidence remains in IMPLEMENTATION_VERIFICATION.md and Git history; raw worker logs stay in the task directory.
