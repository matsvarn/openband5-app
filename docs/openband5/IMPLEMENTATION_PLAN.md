...
**Implementation paused:** The VO₂max/import unit is accepted and included in this local commit. Stop before another unit. Send the requested read-only Fable consultation and discuss a smaller product scope and simpler Paper/acceptance process with Mats. Do not start another unit or treat the archive checklist as a newly approved release scope.

Only `edge/`, branch `openband5/ios-device-setup`, PR1. No push, merge, deploy, personal data, physical device or Bluetooth authority. Preserve the six unrelated untracked assets. Mats task: `/private/tmp/openband-alpin-20260919`. Lead owns Paper, integration and acceptance; workers use isolated clones.

Latest accepted commit before this unit: **e5170ca0**, dated journal weight. Earlier accepted units, contracts, limitations and evidence remain in `IMPLEMENTATION_VERIFICATION.md` and Git history; do not rebuild them. The existing checklist records implementation state, not completion of the whole product.

### Current unit: manual VO₂max and truthful import receipts

Schema67 stores dated manual values with stable IDs, immutable revisions, CAS editing, removal/restoration and idempotent retry. Measurement date, entry time, declared method and manual source remain distinct. No physiological estimator or invented reference classification. Compatible backup chains append; corrupt/divergent chains are withheld without erasing other committed work. Import receipts distinguish committed revisions, conflicts, unreadable entries, interrupted imports and recalculation failure.

Authors: storage453b5569, adaptersa9339334, UI fdec77fd, receipt6ed86d1b, native75b60abf. Fresh independent reviews: storage3111f178, adapters1a81ce83, UI59c13272 and receipt9ea9f761. Final author/review assignments and raw reports are retained in the Mats task. Lead inspected the actual diffs and accepted the completed unit:2188 required tests,114-item clean analysis,132/795 manifest; Pro and mini interaction runs pass, all64 final native PNGs and9 goldens inspected. Details and failed-run limits are in IMPLEMENTATION_VERIFICATION.md. All implementation workers are idle or retired.

Paper: detail52B4/52C0, empty525E/5289, editor52PA/52R9, new52T6/52V3, history53OY/53PW, missing/error/partial/conflict and large-text variants in `vo2-paper/index.json`; import receipt546Q/549N,54EI/54FE,54GA/54H6 in `vo2-receipt-paper/index.json`. Blocks registry132/795. Nine final goldens inspected, hashes in `build/vo2-acceptance/inspected-golden-hashes.json`. Light/dark and mini native review is complete.

### Work deliberately stopped

Nutrition foundation worker72d8718b was interrupted and retired; PGID38351 absent, evidence `nutrition-interrupted-evidence.json` in the Mats task. Partial `domain.dart`/`meal_draft_data.dart` work stays unaccepted in `nutrition-draft-data-clone`. Do not integrate it. Future nutrition Paper drafts are preserved without further expansion. Existing goals, day/week, water, recent reuse and saved-row editing are already implemented; do not rebuild them.

Open source-backed limitations remain open: VO₂max reference classification lacks a versioned licensed catalog; full Health hub parity, A08 detail migrations and other checklist gaps have not been accepted by this unit. Journal weight does not complete dated Health import/profile adoption. Physical interruption/recovery, physiological validity and firmware/channel interpretation remain separate proof requirements.

VO₂max/import integration committed as **bcc9a90e**. Fable consultation completed read-only: task `/private/tmp/openband-scope-rethink-20260921`, worker38312aa2/27ea2376. Report: `workers/38312aa2-4027-4fc6-a3dc-7b7d9a9f2362/27ea2376-07b6-4d4e-9ce8-18fc2074829e.report.md` under that task. Brief retained in the Alpin task as `fable-rethink-brief.txt`.

Fable recommends a reliable daily band/sleep release, physical capture/recovery proof, frozen secondary expansion, fewer canonical Paper screens and one implementer plus one reviewer. Lead agrees with narrowing scope and proportional verification; blanket hiding of completed modules and deletion of archive checklist history are not accepted decisions. No features, Paper areas or checklist history were removed during this consultation. No writer is active. **Next action: discuss release scope and priorities with Mats; do not resume implementation or launch another consultation automatically.**
