...
Lead owns main, Paper, integration and acceptance. Branch `openband5/ios-device-setup`, edge only. Local commits only; no push, deployment, personal data, physical device or Bluetooth access. Preserve six unrelated untracked assets. Task `/private/tmp/openband-alpin-20260919`; isolated writer clones have no remotes and reject pushes. Paper Designphase3 `01M2TRX5GZKAXKTSXK7D34E8AY`, pageN-0; Designphase2 stays frozen. Keep copy minimal and require near-exact Paper/native parity.

Accepted: `2080b03` saved-food editing/recovery (810 tests, clean analyzer,31goldens and106native PNGs inspected). Current backend unit adds atomic retained-draft CAS and water delta contracts:864requiredtests,52-item analyzer and110-block/246-screen manifest pass. See IMPLEMENTATION_VERIFICATION.md. UI parent/water/selector integration is not accepted yet. Previous69aca3d reconciles version0.9.31+67 including all widget/watch configurations;3455fb5 ledger;080d971 Journal;ada1ff8 dated goals.

Active ownership (all through Mats configured routes):
- Water `377f8258/c699fc22`,grok-cursor, nutrition-water-ui-clone,600s: add same-day external revision refresh without losing pending writes/manual sheet/conflict. Prior repairda746480 passed60focusedtests/scopedanalyzer;12goldens inspected. Independent review21326217/c10b576b and lead findings corrected silent save failures, post-commit read errors, stale success, Journal save/navigation latch and reload failure. Not integrated. Public API OpenBandWaterCard(repository,day,onSaved?,revision=0).
- Parent UI `d62038f0/8121b0e3`,grok-cursor,nutrition-parent-ui-v2-clone,1200s: nutrition.dart/browser, focusedparent/meal/targettests and nutrition-parent goldens only. Complete day/week/recents and guarded CAS draft/reuse. Add revision=0, preserve pending draft/Undo on same-day refresh; remove route host to separate file. Brief nutrition-ui-v2-brief.txt.
- Routes `9db317ab/d9b30a1f`,grok-pi,nutrition-parent-routes-v2-clone,900s: newnutrition_route.dart,app/gallery/daily_activity, legacy retirement and actual live-revision/router tests. Receives UI source read-only. Route passes AppState.insightsRevision without every-tick rereads. Keep barcode/OFF legacy leaf reachable until migrated. Brief nutrition-routes-v2-brief.txt.
- Previous parentaa1b09c5/4c56367a timed out,PGID43314 absent,retired/reconciled. Partial work preserved in nutrition-day-parent-clone; no parent source integrated. It deleted meaningful live-update tests without replacement; successors must repair behavior and tests.
- Shared selector dd619507/2f60ee66 idle,alpin-segmented-clone:10focusedtests,compactgoalchecks,scopedanalyzer pass;4PNGs inspected. Correct393→361/375→343 insets; normalhorizontal,2xstacked, selected-weight measurement and nonlinear scaling. Not integrated.
- CAS ae941000/fcbfb8b6 accepted after lead source review and freshd730eb16/cd26baf2 scrutiny. Earlier reviewer040d0a7e timeout reconciled; never resume. Backend source now integrated, no schema/algo changes.
- Discovery651a8551 idle: nutritionbf2bec93, A01 audit3244c125, A02 audit125f1220, sleepcapabilitybff1839f collected. Reports read; final source/Paper judgment stays with lead.

Paper prepared/inspected: current exact nutrition-parent-v3-jsx.json includes canonical18/24title12/16subtitle; day433T/43ID, week3ZYY/401D, library403Q/40H3, picker43W3/4411 andlarge375day44BN. Water42ZV/4381,unknown43CD,2x43CS,readerror43D7,manual43HS/43QQ,saveerror43RB,deltaerrors449V/44AG. Selector44B7/44BG. Large-day below-fold meal rows still need adapted variant inspection. Exports in task state. All working indicators released.

Next: collect worker revisions, supply accepted dependencies, inspect diffs and actual screenshots, independent parent review, extend native review flow, run Pro+mini and inspect every PNG. Register accepted blocks/states and commit UI unit. Do not equate backend completion or Paper-only design with accepted screen implementation. A01 working checklist now has evidence-backed14dispositions (1implementedUI,3partial,10open); review/commit separately. A02 reconciliation remains pending.

Next sleep possibilities have real stored sources: SOL metric sol_min from manual/confirmed windows; learned sleepneed and bedtime from current/version-gated crossday sleep_coach. Keep user goal separate and verify wrong-night attainment B136 before percentages. SpO2 remains disabled in producer; rawLED ADC is not an SpO2 curve. Audit report gives source paths; verify before implementation/disposition.

Remaining: nutrition search/manual/barcode/photo/Health/library recipes/favorites/customfoods, draft rowedit/Undo/portions/aggregate nutrients/dayclose; Journal dated pairs/order/pin/definitions/timeddrinks; training catalogue/customUUID/archive/templates/history; A08 import/export/coach/widgets; glucose Health error distinctions,cycle flags,medication history; A01 lowerfeed/customization/livechip. Shared dark actions/older2x/legacy cleanup/final parity remain. Missing repository methods do not establish unsupported status. Genuine requirements stay open.

Authority incident closed: explicit user-authorized exact-head deletion of origin/openband5/journal-custom-fields at987b9e920754eb66f7e34264c85f3497d2950562 verified absent. Retired7da2faf5 must never resume. No other remote writes authorized.

Release source:0.9.31+67,algo90,schema61; protocolfe1464db98b84ac4d3ce6175d54ada11356d6c62,analytics1fa8144a5e3b728ce91eeed6ecbc15d482933b44 match lock. SDK ~/.local/share/flutter/3.41.6/bin/flutter. Final release-readiness remains open. Never create test/goldens; commit approved PNGs only under test/openband_goldens. Dedicated synthetic Pro/mini only.
