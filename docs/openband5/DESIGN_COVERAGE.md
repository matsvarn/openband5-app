...
| [screens/journal_compose.dart](../../lib/ui2/screens/journal_compose.dart)<br>[screens/custom_journal_field_sheet.dart](../../lib/ui2/screens/custom_journal_field_sheet.dart) | Ansichten: Dein Journal, gespeichert, Speicherfehler und Änderungen verwerfen; Muster: Formularfeld, Auswahl, eigener Eintrag | Stimmung, Schlafqualität, Energie, Stress, Muskelkater 1–5; Wasser, Koffein mit Uhrzeit, Alkohol mit Uhrzeit, Bildschirmzeit, Gewicht, Tags und Notiz. Eigene binäre Felder. Gewichtstrend erhält Lücken und keine ungefragten Ziele oder Benachrichtigungen. |
