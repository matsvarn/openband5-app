...
def main():
    ...
    parser.add_argument('--flow', choices=['all', 'release', 'correction', 'journal', 'journal-hub', 'nutrition-entry', 'nutrition-parent', 'sleep-plan', 'naps', 'exercise-picker', 'custom-exercise', 'exercise-copy', 'custom-load', 'glucose', 'medications', 'cycle', 'cycle-measurements', 'cycle-observations', 'cycle-gaps', 'cycle-medians', 'cycle-comparison', 'night-scalar', 'night-cards', 'sleep-legend', 'respiration', 'temperature', 'weight', 'vo2'], default='release',
                        help='Native capture flow: reduced release (default), sleep correction, full gallery (--flow all), Journal, Journal hub, saved food entry, nutrition parent, sleep plan, naps, exercise picker, custom exercise, custom load, glucose, medications, cycle, cycle measurements, cycle observations, cycle gaps, cycle medians, cycle comparison, HRV/resting pulse detail, compact night cards, the Sleep-stage legend, respiration detail, temperature detail, dated journal weight, or manual VO2max.')
