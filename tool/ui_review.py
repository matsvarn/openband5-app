...
def main():
    ...
    parser.add_argument('--flow', choices=['all', 'journal', 'journal-hub', 'nutrition-entry', 'nutrition-parent', 'sleep-plan', 'exercise-picker', 'custom-exercise', 'exercise-copy', 'custom-load', 'glucose', 'medications', 'cycle', 'cycle-measurements', 'cycle-observations', 'cycle-gaps', 'cycle-medians', 'cycle-comparison', 'night-scalar', 'night-cards', 'sleep-legend', 'respiration'], default='all',
                        help='Native capture flow: full gallery (default), Journal, Journal hub, saved food entry, nutrition parent, sleep plan, exercise picker, custom exercise, exercise copy, custom load, glucose, medications, cycle, cycle measurements, cycle observations, cycle gaps, cycle medians, cycle comparison, HRV/resting pulse detail, compact night cards, the Sleep-stage legend, or respiration detail.')
