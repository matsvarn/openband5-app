...
def main():
    ...
    parser.add_argument('--flow', choices=['all', 'journal', 'journal-hub', 'nutrition-entry', 'nutrition-parent', 'sleep-plan', 'exercise-picker', 'custom-exercise', 'exercise-copy', 'custom-load', 'glucose', 'medications', 'cycle', 'cycle-measurements', 'cycle-observations', 'cycle-gaps', 'cycle-medians', 'cycle-comparison', 'night-scalar', 'night-cards', 'sleep-legend', 'respiration', 'temperature', 'weight', 'vo2'], default='all',
